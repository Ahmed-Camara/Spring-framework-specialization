...
public class StudentControllerTest {
	...
	void testAdd() {
		...
		ResponseEntity<Student> response = new RestTemplate().getForEntity("http://localhost:8081"+
				locationURL,Student.class);
	...
	@Test
	void testGetAll() {
		ResponseEntity<Collection<Student>> responseEntity = new RestTemplate().exchange(URL,
	...
	void testGetOnePathParam() {
		ResponseEntity<Student> responseEntity = new RestTemplate().exchange(URL+"/{id}", HttpMethod.GET,
				null,Student.class, 3);
